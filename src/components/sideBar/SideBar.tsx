...
export default function SideBar() {
  return (
      <div className="flex flex-col justify-between gap-6 p-5 border-r-gray-800 border-r min-h-screen">

        <div className="navigation flex flex-col gap-4 text-sm font-light">
          <svg className="mb-6" width="45" height="50" viewBox="0 0 363 399" id="logo" fill="none"
            ...
            <path
                ...
                fill="url(#paint2_radial_0)"></path>
            <defs>
              <linearGradient id="paint0_linear_0" x1="264.38" y1="53.7644" x2="45.98" y2="436.614"
              ...
              <linearGradient id="paint1_linear_0" x1="288.51" y1="362.514" x2="46.98" y2="133.834"
                              gradientUnits="userSpaceOnUse">
              ...
              <radialGradient id="paint2_radial_0" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
